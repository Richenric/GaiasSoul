...
* **Escudo:** El jugador conjurará el escudo para defenderse con el click derecho del ratón,
...
* **En el offline**, se batirán dos personajes en duelo en el mismo terminal, ganando el que consiga mayor puntuación.
